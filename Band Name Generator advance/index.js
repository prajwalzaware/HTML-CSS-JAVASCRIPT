...
app.post("/submit", (req, res) => {
  ...
  var  adjIndex = adj[Math.floor((Math.random() * adj.length))];
  var  nounIndex = noun[Math.floor((Math.random() * noun.length))];

  res.render("index.ejs",{adje:adjIndex,nounn:nounIndex});
